...
contract instabilityAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"instabilityAI";
    string private constant _symbol = unicode"instabilityAI";
